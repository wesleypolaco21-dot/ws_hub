...
-- KEYBIND
local RESET_KEY = Enum.KeyCode.X
...
-- MOBILE BUTTON
local screenGui = Instance.new("ScreenGui")
screenGui.Name = "InstaResetMobile"
...
button.MouseButton1Click:Connect(instaReset)

-- PANEL BUTTON
task.spawn(function()
    local gui = player.PlayerGui:WaitForChild("AutoStealUI", 10)
    ...
    resetBtn.MouseButton1Click:Connect(instaReset)
end)
